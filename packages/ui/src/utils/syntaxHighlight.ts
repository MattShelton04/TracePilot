...
const TS_KEYWORDS = [
  ...
  "default", "true", "false", "null", "undefined", "void", "delete",
  "readonly", "abstract", "static", "private", "protected", "public",
  "declare", "module", "require", "keyof", "infer", "satisfies",
];

const RUST_KEYWORDS = [
  "fn", "let", "mut", "const", "static", "struct", "enum", "impl", "trait",
  "pub", "use", "mod", "crate", "self", "super", "where", "for", "in",
  "if", "else", "match", "loop", "while", "break", "continue", "return",
  "async", "await", "move", "ref", "as", "type", "dyn", "unsafe",
...
const CSS_KEYWORDS = [
  "display", "position", "flex", "grid", "block", "inline", "none",
  "relative", "absolute", "fixed", "sticky", "auto", "inherit",
  "important", "solid", "dashed", "dotted", "hidden", "visible",
...
const SQL_KEYWORDS = [
  ...
  "RIGHT", "INNER", "OUTER", "ON", "AND", "OR", "NOT", "IN", "IS",
  "NULL", "AS", "ORDER", "BY", "GROUP", "HAVING", "LIMIT", "OFFSET",
  "UNION", "ALL", "DISTINCT", "EXISTS", "BETWEEN", "LIKE", "PRIMARY",
  "KEY", "FOREIGN", "REFERENCES", "DEFAULT", "CASCADE", "CONSTRAINT",
  "COUNT", "SUM", "AVG", "MIN", "MAX", "TEXT", "INTEGER", "BOOLEAN",
  "VARCHAR", "TIMESTAMP", "SERIAL", "DESC", "ASC",
];

const SHELL_KEYWORDS = [
  "if", "then", "else", "elif", "fi", "for", "while", "do", "done",
  "case", "esac", "function", "return", "exit", "echo", "export",
  "source", "alias", "unalias", "cd", "pwd", "ls", "cat", "grep",
  "sed", "awk", "find", "xargs", "pipe", "sudo", "chmod", "chown",
  "mkdir", "rm", "cp", "mv", "git", "npm", "pnpm", "yarn", "cargo",
  "docker", "kubectl",
];
...
const GO_KEYWORDS = [
  ...
  "error", "string", "int", "bool", "byte", "float64", "append",
...
function rustRules(): TokenRule[] {
  return [
    ...
    { pattern: /'[^'\\]'/g, className: "string" },
    { pattern: /\b\d+(?:\.\d+)?(?:_\d+)*(?:u8|u16|u32|u64|i8|i16|i32|i64|f32|f64|usize|isize)?\b/g, className: "number" },
