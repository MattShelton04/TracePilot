...
/** Sanitized raster preview generated by the backend. */
export interface SessionImagePreview {
  /** Base64-encoded, metadata-free PNG. */
  base64Data: string;
  width: number;
  height: number;
...
/** One line match from a bounded session-wide file-content search. */
export interface SessionFileSearchMatch {
  path: string;
...
/** Results and coverage metadata from session-wide file-content search. */
