...
| [Copilot Session-Store Enrichment](features/copilot-session-store-enrichment-design.md) | Delivered optional request billing, performance, cache and linked-work enrichment from the CLI session store, with coverage and fallbacks. |
