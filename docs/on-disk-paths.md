...
| `~/.copilot/pkg/<platform>/<version>/definitions/` | Copilot CLI | YAML agent definitions. | `config_injector::read_agent_definitions`. | Directory name centralized as `COPILOT_DEFINITIONS_DIR`. Edits require validation and backups. |
