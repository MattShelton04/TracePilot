...
<template>
  <div class="instructions-section">
    ...
    <div class="md-toolbar">
      <button class="md-toolbar-btn" title="Bold" :disabled="ctx.isReadOnly" @click="ctx.insertBold">
      ...
      <button class="md-toolbar-btn" title="Italic" :disabled="ctx.isReadOnly" @click="ctx.insertItalic">
        <svg viewBox="0 0 16 16" fill="currentColor"><path d="M6 2h6v2h-2.2l-2.6 8H9v2H3v-2h2.2l2.6-8H6V2z"/></svg>
      </button>
      <div class="md-toolbar-sep" />
      <button class="md-toolbar-btn md-toolbar-btn--text" title="H1" :disabled="ctx.isReadOnly" @click="ctx.insertH1">H1</button>
      <button class="md-toolbar-btn md-toolbar-btn--text-sm" title="H2" :disabled="ctx.isReadOnly" @click="ctx.insertH2">H2</button>
      <div class="md-toolbar-sep" />
      <button class="md-toolbar-btn" title="Bullet List" :disabled="ctx.isReadOnly" @click="ctx.insertBulletList">
      ...
      <div class="md-toolbar-sep" />
      <button class="md-toolbar-btn" title="Code" :disabled="ctx.isReadOnly" @click="ctx.insertCode">
      ...
      <button class="md-toolbar-btn" title="Link" :disabled="ctx.isReadOnly" @click="ctx.insertLink">
