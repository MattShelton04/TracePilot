...
<template>
  <div class="cb-disconnected">
    ...
    >
      {{ ctx.sdk.isConnecting ? 'Connecting…' : 'Connect' }}
      <svg v-if="!ctx.sdk.isConnecting" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="14" height="14">
        <path d="M6 4l4 4-4 4" />
      </svg>
    </button>
  </div>
