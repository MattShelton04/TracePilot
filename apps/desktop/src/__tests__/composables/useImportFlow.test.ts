...
function makePreviewResult(
  ...
  return {
    valid: true,
    sessions: [
      { id: 'sess-1', summary: 'Session 1', repository: null, createdAt: '2026-01-01', sectionCount: 3, alreadyExists: false },
      { id: 'sess-2', summary: 'Session 2', repository: null, createdAt: '2026-01-02', sectionCount: 3, alreadyExists: false },
    ],
    issues: [],
    schemaVersion: '1.0',
  ...
  describe('validateFile', () => {
    ...
    it('discards stale responses from rapid file selections', async () => {
      ...
      const secondResult = makePreviewResult({
        sessions: [{ id: 'new', summary: 'New', repository: null, createdAt: '2026-01-03', sectionCount: 2, alreadyExists: false }],
      });
