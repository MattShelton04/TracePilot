...
"#
    ...
    fs::write(
        ...
        concat!(
            ...
            r#"{"type":"session.shutdown","data":{"shutdownType":"routine","totalPremiumRequests":1,"totalApiDurationMs":5000,"totalNanoAiu":2500000000,"sessionStartTime":1773308090000,"currentModel":"claude-opus-4.6","modelMetrics":{"claude-opus-4.6":{"requests":{"count":2,"cost":0.5},"usage":{"inputTokens":500,"outputTokens":200},"totalNanoAiu":2500000000}}},"id":"evt-7","timestamp":"2026-03-10T07:15:00.000Z","parentId":null}"#, "\n",
        ),
    )
    .unwrap();
    session_dir
