...
async function run() {
  ...
  try {
    ...
    fail("Navigate to Tasks dashboard", e.message);
  }
  ...
  try {
    ...
    if (presetCards > 0) {
      ...
      else fail("Quick presets layout", `icon=${hasIcon} info=${hasInfo} arrow=${hasArrow}`);
    } else {
    ...
    fail("Quick presets render", e.message);
  }
  ...
  try {
    ...
    fail("Quick preset card tag", e.message);
  }
  ...
  try {
    ...
    fail("Navigate to Orchestrator Monitor", e.message);
  }
  ...
  try {
    ...
    fail("Health check IPC", e.message);
  }
  ...
  try {
    ...
    fail("Health after stop IPC", e.message);
  }
