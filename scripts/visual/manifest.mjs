...
export const cases = [
  ...
  },
  {
    ...
    ready: "h1",
    state: "experimental; populated paused replay",
  },
  { id: "export", route: "/export", ready: "h1", state: "experimental; session picker" },
  {
    id: "export-preview",
    route: "/export?sessionId=sess-auth-refactor&preset=minimal-team-log",
    ready: ".preview-footer",
    command: "preview_export",
    state: "experimental; selected session and populated Markdown preview",
  },
  ...
  },
  {
    ...
    route: "/orchestration",
    ready: "h1",
    state: "SDK disconnected; fixture sessions",
  },
  {
    id: "worktree-manager",
  ...
  },
  {
    ...
    ready: "h1",
    state: "experimental; fixture configuration",
  },
  { id: "mcp-manager", route: "/mcp", ready: ".mcp-server-card, .server-card", state: "populated" },
  {
    id: "mcp-server-detail",
    route: "/mcp/visual-files",
    ready: ".detail-server-name",
    state: "configured; no network health check",
  },
  ...
  },
  {
    ...
    route: "/cli-context",
    ready: "h1",
    state: "experimental; no captured external context",
  },
